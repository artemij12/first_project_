...
void count_and_time_rot(opt_pin)
{
//в этой функции будет реализован подсчет количества оборотов крыльчатки и времени, на которое прерывается оптопара
}
loop () 
{
   //ПЕРЕПИСАТЬ....НЕ БУДЕТ РАБОТАТЬ ....МНОГО НЕ ВЕРНОГО КОДА...И НЕ ОПТИМАЛЬНОГО ...
  // Лучше используй переменную mode
 // if (push_set()==TRUE)
 //если кнопка нажата один раз,то начинают выводиться режимы работы прибора
